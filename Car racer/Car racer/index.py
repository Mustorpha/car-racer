...
class CarRacing:
    ...
    def initialize(self):
        ...
        self.carImg = pygame.image.load('.\\character\\car.png')
        self.car_x_coordinate = (self.display_width * 0.45)
        self.car_y_coordinate = (self.display_height * 0.8)
        self.car_width = 49

        # enemy_car
        self.enemy_car = pygame.image.load('.\\character\\enemy_car_1.png')
        ...
        # Background
        self.bgImg = pygame.image.load(".\\character\\back_ground.jpg")
